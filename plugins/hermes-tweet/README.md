...
Hermes Tweet supports public X/Twitter research, timeline reading, and optional
account actions in Hermes Agent. It keeps write actions explicitly gated while
leaving read-only discovery workflows available for planning and analysis.
